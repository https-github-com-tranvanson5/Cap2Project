...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/CurriculumVitae/updateCv").hasAnyAuthority("ROLE_USER")
                .antMatchers("/api/CurriculumVitae/getCvbyIdbyUser").hasAnyAuthority("ROLE_USER")
                .antMatchers("/api/CurriculumVitae/getAllCvByUser").hasAnyAuthority("ROLE_USER")
//                .antMatchers("/api/CurriculumVitae/getAllCvByUser").permitAll()
