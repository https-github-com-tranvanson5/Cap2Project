...
function RecruiterPost() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (id) {
                ...
                setFormData({
                    ...
                    recruitmentStartDate:
                        jobDataRecruiterDetail?.recruitmentStartDate || '',
                    recruitmentEndDate:
                        jobDataRecruiterDetail?.recruitmentEndDate || '',
                    ...
                    jobDescription:
                        jobDataRecruiterDetail?.jobDescription || '',
                    skillDescription:
                        jobDataRecruiterDetail?.skillDescription || '',
                    benefit: jobDataRecruiterDetail?.benefit || '',
                    careers: (jobDataRecruiterDetail?.careers || []).map(
                        (career) => career.id,
                    ),
                    ...
                    companyDescription:
                        jobDataRecruiterDetail?.companyDescription || '',

                    //thông tin liên hệ
                    contactName: jobDataRecruiterDetail?.contactName || '',
                    contactAddress:
                        jobDataRecruiterDetail?.contactAddress || '',
            ...
            setListCareerId(
                (jobDataRecruiterDetail?.careers || []).map(
                    (career) => career.id,
                ),
            );
        };
    ...
    const handleUploadFirebase = async () => {
        ...
        try {
            ...
            const uploadedImageUrl = await Promise.resolve(
                FirebaseFileUploader(imageUpload, storageRef),
            );
                                            ...
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <CompareValidator
                                                        ...
                                                        message={
                                                            'Ngày tuyển dụng phải lớn hơn ngày hiện tại'
                                                        }
                                                    />
                                                </div>
                                            </Col>
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <CompareValidator
                                                        ...
                                                        message={
                                                            'Ngày kết thúc phải lớn hơn ngày tuyển dụng'
                                                        }
                                                    />
                                                </div>
                                            </Col>
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <IsEmptyValidator
                                                        ...
                                                        messageIsEmpty={
                                                            'Lương khởi điểm không được để trống'
                                                        }
                                                        onValidation={(
                                                            isValid,
                                                        ) =>
                                            ...
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <CompareValidator
                                                        ...
                                                        message={
                                                            'Lương tối đa không được thấp hơn lương khởi điểm'
                                                        }
                                                    />
                                                </div>
                                            </Col>
                                            ...
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <IsEmptyValidator
                                                        ...
                                                        messageIsEmpty={
                                                            'Kiểu công việc không được để trống'
                                                        }
                                                        onValidation={(
                                                            isValid,
                                                        ) =>
                                            ...
                                            <Col>
                                                ...
                                                >
                                                    ...
                                                    <IsEmptyValidator
                                                        ...
                                                        messageIsEmpty="Mô tả yêu cầu kỹ năng cho công việc không được để trống"
                                                        onValidation={(
                                                            isValid,
                                                        ) =>
                                                            handleValidation(
